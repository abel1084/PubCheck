...
must_haves:
  truths:
    - "User can open Settings and see three template tabs (Factsheet, Brief/Paper, Publication)"
...
- Settings UI with document type tabs
...
1. User can open Settings and see document type tabs
